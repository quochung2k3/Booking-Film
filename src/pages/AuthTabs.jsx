    ...
    return (
        <div style={styles.container}>
            <div style={styles.tabsContainer}>
                <button
                    style={activeTab === 'signIn' ? {...styles.tabButton, ...styles.activeTab} : styles.tabButton}
                    onClick={() => handleTabSwitch('signIn')}
                >
                    Sign In
                </button>
                <button
                    style={activeTab === 'signUp' ? {...styles.tabButton, ...styles.activeTab} : styles.tabButton}
                    onClick={() => handleTabSwitch('signUp')}
                >
                    Sign Up
                </button>
                <button
                    style={activeTab === 'forgotPassword' ? {...styles.tabButton, ...styles.activeTab} : styles.tabButton}
